...
import org.jboss.arquillian.container.osgi.felix.FelixEmbeddedDeployableContainer;
...
public class BundleUndeployTest {
    ...
    private static class MyFelixContainer extends FelixEmbeddedDeployableContainer {
    ...
    public void testUninstall() throws Exception {
        MyFelixContainer container = new MyFelixContainer();
        ...
        try {
            ...
            Class<?> aClass = dependentBundle.loadClass("org.jboss.test.arquillian.container.felix.sub.A");
            ...
            Class<?> bClass = dependentBundle.loadClass("org.jboss.test.arquillian.container.felix.sub.B");
        } catch (Exception e) {
            throw e;
        } finally {
